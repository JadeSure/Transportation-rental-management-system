...
public class DateTime {
	...
	// the date of string type is yyyy-mm-dd
	public DateTime(String date,int flag) {
		if(flag == 0) {
			//for input date type = dd/mm/yyyy
			...
			//for input date type = yyyy/mm/dd
	...
	public static String formatDateType(DateTime time) {
		String newTime =time.getFormattedDate();
		String str1[] = newTime.split("/");
		String newType = str1[2]+"-"+ str1[1]+ "-" +str1[0];	
		return newType;
	}
